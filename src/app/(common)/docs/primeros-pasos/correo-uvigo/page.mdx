...
universidad**. Al lugar donde estas suelen llegar es al [**correo de la UVigo**](https://correoweb.uvigo.gal/login.php).
...
6.  **Atención** 🛑 Si después del punto anterior (5) te sale una ventana
...
7.  Ahora **configura las opciones** a tu gusto junto con el nombre que
